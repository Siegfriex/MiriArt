...
| JDBC URL | `jdbc:mysql://10.99.0.3:3306/miriart_prod` |
...
| `miriart-frontend-oauth-url` | OAuth 성공 후 FE 리다이렉트 URL | miriart-be | ✅ 등록 완료 (`https://miri-art.vercel.app/auth/callback`) |
